...
export default function NewsFeed() {
  ...
  return (
    <section id="news" className="card" aria-labelledby="news-heading">
      <div className="card-header">
        <h2 id="news-heading" className="card-title" style={{ margin: 0 }}>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  <time dateTime={item.published} className="text-muted">
